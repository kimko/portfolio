...
export const projects = [
  {
    ...
    heroImage: `${base}images/small-table/hero.jpg`,
    images: [
      { src: `${base}images/small-table/hero.jpg`, alt: 'Completed small table' },
    ],
  },
  {
    id: 'shaker-bench',
    ...
    heroImage: `${base}images/shaker-bench/hero.jpg`,
    images: [
      { src: `${base}images/shaker-bench/hero.jpg`, alt: 'Completed Shaker-style bench' },
      { src: `${base}images/shaker-bench/detail-1.jpg`, alt: 'Bench joinery and construction details' },
    ],
  },
  {
    ...
    heroImage: `${base}images/shaker-nightstands/hero.jpg`,
    images: [
      { src: `${base}images/shaker-nightstands/hero.jpg`, alt: 'Pair of Shaker-style nightstands' },
      { src: `${base}images/shaker-nightstands/detail-1.jpg`, alt: 'Nightstand detail view' },
      { src: `${base}images/shaker-nightstands/detail-2.jpg`, alt: 'Nightstand construction detail' },
      { src: `${base}images/shaker-nightstands/detail-3.jpg`, alt: 'Nightstand close-up' },
    ],
  },
  {
    id: 'mcm-coffee-table',
    ...
    heroImage: `${base}images/mcm-coffee-table/hero.jpg`,
    images: [
      { src: `${base}images/mcm-coffee-table/hero.jpg`, alt: 'MCM coffee table in living space' },
      { src: `${base}images/mcm-coffee-table/detail-1.jpg`, alt: 'Angled leg detail' },
      { src: `${base}images/mcm-coffee-table/detail-2.jpg`, alt: 'Table top and leg joinery' },
    ],
  },
  {
    id: 'dresser',
    ...
    heroImage: `${base}images/dresser/hero.jpg`,
    images: [
      { src: `${base}images/dresser/hero.jpg`, alt: 'Dresser Fusion 360 design render' },
      { src: `${base}images/dresser/detail-1.jpg`, alt: 'Dresser work in progress' },
      { src: `${base}images/dresser/detail-2.jpg`, alt: 'Dresser construction progress' },
      { src: `${base}images/dresser/detail-3.jpg`, alt: 'Dresser 3D model render' },
    ],
  },
];
